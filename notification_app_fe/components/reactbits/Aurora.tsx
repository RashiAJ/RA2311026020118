...
/**
 * Aurora background from React Bits (DavidHDev/react-bits, reactbits.dev).
 * WebGL shader via ogl; MIT license.
 */
...
export default function Aurora({
  ...
  useEffect(() => {
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        uTime: { value: 0 },
        uAmplitude: { value: p0.amplitude },
        uColorStops: { value: colorStopsArray },
        uResolution: { value: [ctn.offsetWidth, ctn.offsetHeight] },
        uBlend: { value: p0.blend },
      },
    });
    ...
    const update = (t: number) => {
      ...
      if (program) {
        ...
        program.uniforms.uTime.value = (t / 1000) * 0.35 * p.speed;
